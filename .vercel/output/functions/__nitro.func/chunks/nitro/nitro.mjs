...
function serialize$4(name, value, options) {
  const opt = options || {};
...
function handleCacheHeaders$1(event, opts) {
...
function setCookie$1(event, name, value, serializeOptions = {}) {
  ...
  const newCookie = serialize$4(name, value, serializeOptions);
...
const setHeaders$1 = setResponseHeaders$1;
...
const PayloadMethods$2 = /* @__PURE__ */ new Set(["PATCH", "POST", "PUT", "DELETE"]);
const ignoredHeaders$1 = /* @__PURE__ */ new Set([
  "transfer-encoding",
  "accept-encoding",
  "connection",
  "keep-alive",
...
async function proxyRequest$1(event, target, opts = {}) {
  let body;
  let duplex;
  if (PayloadMethods$2.has(event.method)) {
  ...
  const fetchHeaders = mergeHeaders$2(
    getProxyRequestHeaders$1(event, { host: target.startsWith("/") }),
...
function getProxyRequestHeaders$1(event, opts) {
  const headers = /* @__PURE__ */ Object.create(null);
  const reqHeaders = getRequestHeaders$1(event);
  for (const name in reqHeaders) {
    if (!ignoredHeaders$1.has(name) || name === "host" && opts?.host) {
...
function fetchWithEvent(event, req, init, options) {
  return _getFetch$1(options?.fetch)(req, {
    ...
    headers: {
      ...getProxyRequestHeaders$1(event, {
...
async function updateSession(event, config, update) {
  ...
  if (config.cookie !== false) {
    ...
    setCookie$1(event, sessionName, sealed, {
      ...DEFAULT_COOKIE,
...
const _assets = {
  ["nuxt-og-image:fonts:Inter-normal-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2025-12-31T09:50:34.791Z"}
  },
  ["nuxt-og-image:fonts:Inter-normal-700.ttf.base64"]: {
    import: () => import('../raw/Inter-normal-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2025-12-31T09:50:34.792Z"}
  }
};
...
function serialize$2(object) {
  const hasher = new Hasher();
  hasher.dispatch(object);
  return hasher.buff;
}
function hash$1(value) {
  return digest$1(typeof value === "string" ? value : serialize$2(value)).replace(/[-_]/g, "").slice(0, 10);
}
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "ed6798e0-60f0-4f87-9c8d-0c40557bb2f7",
  ...
  "session": {
    "name": "nuxt-session",
    "password": "dbb0372f7cef4be2b5390624b7e67acc",
    "cookie": {
      "sameSite": "lax"
    }
  },
  ...
  "nuxt-robots": {
    ...
    "sitemap": [
      "https://image-gallery.nuxt.dev/sitemap.xml",
      "/sitemap.xml"
    ],
    "header": true,
...
function createRouteRulesHandler(ctx) {
  return eventHandler$1((event) => {
    ...
    if (routeRules.proxy) {
      ...
      return proxyRequest$1(event, target, {
...
const _G5n7IjIek1QNeNsfmhEd0blPNaiM88jGspYYCbsnUow = defineNitroPlugin((nitroApp) => {
...
const _u1XrKkTFpDax_y0GtLNu4kTOjk7y28s0Y7BexuQJBA = defineNitroPlugin(async (nitroApp) => {
...
const _UdjMKVjwGW0T7dcwiFN7z5S_rTwpCUy2x3YZp63Y = defineNitroPlugin(async (nitroApp) => {
...
const _7bD361IRetWDUWaeEa3DlRgDa9uOO1lpSt2ZZab2DRk = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _Arp9tvFfvWMw0gSoEFgTE52QMduH9oEn69LLK_wr_WY = (function(nitro) {
...
const plugins = [
  _G5n7IjIek1QNeNsfmhEd0blPNaiM88jGspYYCbsnUow,
_u1XrKkTFpDax_y0GtLNu4kTOjk7y28s0Y7BexuQJBA,
_UdjMKVjwGW0T7dcwiFN7z5S_rTwpCUy2x3YZp63Y,
_7bD361IRetWDUWaeEa3DlRgDa9uOO1lpSt2ZZab2DRk,
_Arp9tvFfvWMw0gSoEFgTE52QMduH9oEn69LLK_wr_WY
];
...
function createToken(expiresInHours = 24) {
  const token = generateToken();
  const now = Date.now();
  const expiresAt = now + expiresInHours * 60 * 60 * 1e3;
...
const _cHHgJl = defineCachedEventHandler(async (event) => {
...
const _94_cOT = eventHandler$1(async (event) => {
  await clearUserSession(event);
  return { loggedOut: true };
});

const _d30AGt = eventHandler$1(async (event) => {
...
const _TvmV2q = eventHandler(async (e) => {
...
const _jVQyZA = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _dSnTV5 = defineEventHandler(async (e) => {
...
const _Zdk2zG = defineEventHandler(async (e) => {
...
const _9KkGE4 = defineEventHandler(sitemapXmlEventHandler);

const _nLGcPE = defineEventHandler((e) => {
  const path = e.path;
...
async function getIslandContext(event) {
  ...
  const context = event.method === "GET" ? getQuery$2(event) : await readBody$1(event);
  const ctx = {
    url: "/",
    ...context,
    id: hashId,
...
const _lazy_77evrl = () => import('../routes/api/auth.post.mjs');
const _lazy_93Dc4b = () => import('../routes/api/gate/generate-link.post.mjs');
const _lazy_CK9Su4 = () => import('../routes/api/gate/validate-token.post.mjs');
const _lazy_f8lh8U = () => import('../routes/api/gate/verify.post.mjs');
const _lazy_9v5U0e = () => import('../routes/renderer.mjs');
const _lazy_NAOGha = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_DF5LJH = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '/api/auth', handler: _lazy_77evrl, lazy: true, middleware: false, method: "post" },
  { route: '/api/gate/generate-link', handler: _lazy_93Dc4b, lazy: true, middleware: false, method: "post" },
  { route: '/api/gate/validate-token', handler: _lazy_CK9Su4, lazy: true, middleware: false, method: "post" },
  { route: '/api/gate/verify', handler: _lazy_f8lh8U, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_9v5U0e, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _cHHgJl, lazy: false, middleware: false, method: undefined },
  { route: '/api/_auth/session', handler: _94_cOT, lazy: false, middleware: false, method: "delete" },
  { route: '/api/_auth/session', handler: _d30AGt, lazy: false, middleware: false, method: "get" },
  { route: '', handler: _TvmV2q, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _jVQyZA, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _dSnTV5, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _Zdk2zG, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _9KkGE4, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_NAOGha, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_DF5LJH, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_DF5LJH, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _nLGcPE, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_9v5U0e, lazy: true, middleware: false, method: undefined }
];
...
export { withQuery as $, getEntryIds as A, renderInlineStyles as B, replaceIslandTeleports as C, useNitroApp as D, defineEventHandler as E, prefixStorage as F, useStorage as G, useNitroOrigin as H, emojiCache as I, useOgImageRuntimeConfig as J, fetchIsland as K, normaliseFontInput as L, theme as M, withTrailingSlash as N, getQuery as O, handleCacheHeaders as P, setHeaders as Q, setHeader as R, hash as S, parseURL as T, setResponseHeader as U, proxyRequest as V, sendRedirect as W, resolveContext as X, H3Error as Y, withBase as Z, destr as _, getCookie as a, i$1 as a0, s$2 as a1, l$1 as a2, serialize as a3, defu as a4, parseQuery$1 as a5, defu$1 as a6, klona as a7, defuFn as a8, headSymbol as a9, setCookie$1 as aA, getCookie$1 as aB, deleteCookie as aC, appendResponseHeader as aD, decodeHtml as aE, logger$1 as aF, toBase64Image as aG, htmlDecodeQuotes as aH, sendError as aI, fontCache as aJ, listener as aK, isEqual as aa, useHead as ab, hasProtocol$1 as ac, joinURL$1 as ad, withQuery$1 as ae, withTrailingSlash$1 as af, withoutTrailingSlash$1 as ag, isScriptProtocol as ah, getContext as ai, sanitizeStatusCode$1 as aj, baseURL as ak, createHooks as al, executeAsync as am, withoutTrailingSlash as an, toRouteMatcher$1 as ao, createRouter$2 as ap, toRouteMatcher as aq, createRouter as ar, withoutBase as as, useSeoMeta as at, stringifyQuery as au, joinURL as av, hasProtocol as aw, withLeadingSlash as ax, getRequestHeader$1 as ay, isEqual$1 as az, createToken as b, createError as c, getHeader as d, eventHandler as e, setCookie as f, getUserSession as g, getResponseStatusText as h, getResponseStatus as i, appId as j, defineRenderHandler as k, buildAssetsURL as l, appTeleportTag as m, appTeleportAttrs as n, getQuery$2 as o, publicAssetsURL as p, createError$2 as q, readBody as r, setUserSession as s, createSSRContext as t, appHead as u, validateToken as v, destr$1 as w, setSSRError as x, getRouteRules as y, getRenderer as z };
