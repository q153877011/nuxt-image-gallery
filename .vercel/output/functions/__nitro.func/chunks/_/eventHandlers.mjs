import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { F as prefixStorage, G as useStorage, H as useNitroOrigin, I as emojiCache, J as useOgImageRuntimeConfig, c as createError, K as fetchIsland, L as normaliseFontInput, M as theme, N as withTrailingSlash, O as getQuery, P as handleCacheHeaders, Q as setHeaders, R as setHeader, S as hash, T as parseURL, U as setResponseHeader, V as proxyRequest, W as sendRedirect, X as resolveContext, Y as H3Error } from '../nitro/nitro.mjs';
